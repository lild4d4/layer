...
module spi_arb (
    ...
    assign ctrl_wlen      = (grant_pick == 1'b0) ? a_wlen  : b_wlen;
    assign ctrl_rlen      = (grant_pick == 1'b0) ? a_rlen  : b_rlen;
    assign ctrl_tx_data   = (grant_pick == 1'b0) ? a_tx_data : b_tx_data;
    assign ctrl_cs_sel    = (grant_pick == 1'b0) ? 1'b1 : 1'b0;
